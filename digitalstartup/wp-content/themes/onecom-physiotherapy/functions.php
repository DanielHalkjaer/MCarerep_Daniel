...
function onecom_theme_assets()
{
    ...
    if ((WP_DEBUG != true || WP_DEBUG != 'true' ) && (SCRIPT_DEBUG != true || SCRIPT_DEBUG != 'true' )) {
        ...
        wp_localize_script('script-oct-physiotherapy-all', 'one_ajax', array(
            ...
            'msg' => __('Please wait...', 'oct-physiotherapy'),
            'subscribe_btn' => __('Subscribe', 'oct-physiotherapy'),
            'send' => __('SUBMIT', 'oct-physiotherapy'),
                )
        );
    } else {
...
function caption_for_shinybox($markup, $id, $size, $permalink, $icon, $text)
{
    ...
    if (empty($_post) || ( 'attachment' !== $_post->post_type ) || !$url = wp_get_attachment_url($_post->ID)) {
        return __('Missing Attachment', 'oct-physiotherapy');
    }
...
function onecom_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => __('Sidebar', 'oct-physiotherapy'),
        'id' => 'oct-sidebar-1',
        'description' => __('Add widgets here to appear in your sidebar.', 'oct-physiotherapy'),
    ...
    // Header Sidebar
    register_sidebar(array(
        'name' => __('Header', 'oct-physiotherapy'),
        'id' => 'oct-header-1',
        'description' => __('Add widgets here to appear in your header.', 'oct-physiotherapy'),
    ...
    // Footer Sidebar
    register_sidebar(array(
        'name' => __('Footer', 'oct-physiotherapy') . ' 1',
        'id' => 'oct-footer-1',
        'description' => __('Add widgets here to appear in your footer.', 'oct-physiotherapy'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
    ...
    register_sidebar(array(
        'name' => __('Footer', 'oct-physiotherapy') . ' 2',
        'id' => 'oct-footer-2',
        'description' => __('Add widgets here to appear in your footer.', 'oct-physiotherapy'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
    ...
    register_sidebar(array(
        'name' => __('Footer', 'oct-physiotherapy') . ' 3',
        'id' => 'oct-footer-3',
        'description' => __('Add widgets here to appear in your footer.', 'oct-physiotherapy'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
